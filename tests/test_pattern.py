...
#         if e.msg.startswith("Compilation failed"):
#             rc = "COMPILE_ERROR"
#         else:
#             rc = "LIB_ERROR"
...
#     s = p.finditer(subject, offset=offset)
...
#     p = pcre2.compile(pattern)
#     assert p.sub(replacement, subject, suball=suball, literal=literal, offset=offset) == result
